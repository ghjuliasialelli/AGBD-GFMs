...
│   │   ├── mapping_lite_to_og.pkl  tile_to_region.pkl  tiles_per_region.pkl
...
| **AGBD-Lite** | Zenodo record [`18485030`](https://zenodo.org/records/18485030). Auto-downloads on first use inside the benchmark fork; download by hand for the supervised code here. | the 11-GFM benchmark; all `lite="true"` runs |
...
| **AGBRef** | in-repo: `comparison/agbref/data/`. | `comparison/agbref/` only |
