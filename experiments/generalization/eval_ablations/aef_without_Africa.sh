...
python eval.py  --dataset_path "$dataset_path" --arch "$arch" --models "${models[@]}" --years "${years[@]}" \
                ...
                --lite "$lite" --bs "$bs" --drop_overlap "$drop_overlap" --force "true" --region "Africa" --keep_region "true" --stats_hold_out_region "Africa" --stats_keep_region "false" --years_stats "2019-2020"
