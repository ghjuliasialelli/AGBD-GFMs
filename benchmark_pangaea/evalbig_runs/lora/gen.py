# Generates the per-encoder eval-on-AGBD-test launchers for ONE fine-tuning regime: the regime is
...
#
# These evaluate on the full AGBD-test set rather than the AGBD-Lite test split, by
# pointing at the `<run>_evalbig` copies that ../gen_evalbig.sh prepares. Run that
# script for this regime FIRST -- the `_evalbig` directories must already exist.
